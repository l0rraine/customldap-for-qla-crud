            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                | LDAP://10.66.2.18/CN=liqiang150.slyt,OU=地质科学研究院,OU=SLYT,OU=组织机构,DC=sinopec,DC=ad
                |
                */

                'base_dn' => 'DC=sinopec,DC=ad',
                ...
                */
                ...
                'admin_username' => env('ADLDAP_ADMIN_USERNAME', 'liqiang150.slyt'),
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'Liqiang150'),
